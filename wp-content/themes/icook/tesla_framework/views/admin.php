...
<form method="post" action="save_options">
  ...
  <div class="tt_top_bar">
    ...
    <div class="tt_theme_logo">
      <span><?php echo THEME_PRETTY_NAME ?></span><?php echo __(" Version ","TeslaFramework") . THEME_VERSION;?> | 
      <span><?php _e("Framework ","TeslaFramework")?></span><?php echo __("Version ","TeslaFramework") . TT_FW_VERSION?>
      <a class="check_update" title="Manual check for theme updates" href="#check_updates"><?php _e('Check Updates','TeslaFramework') ?></a>
          ...
          <?php endif;?>
              <div class="tt_content_box">
                <div class="tt_content_box_title">
                  <span class="tt_bg_icon tt_<?php if(!empty($box['icon'])) echo $box['icon'];?>"><?php printf( __( '%s', 'TeslaFramework' ), $box_name ); ?></span>
                </div>
